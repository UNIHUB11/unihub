...
<body><link rel="stylesheet" href="style4.css">
<!-- New toolbar-->
<style>
* {
			...
			<div class="container-fluid">
				<div class="top-right-strip row">
					...
					<div class="top-hny-left-content col-lg-6 pl-lg-0">
						<h6>Upto 30% off on All Furniture</h6>
					</div>
					<!--//left-->
					<!--/right-->
						...
						<div class="carousel-item active">
							<div class="container">
								<div class="carousel-caption">
									<h3>SOFA
										<br>50% Off</h3>
									<a href="#product" class="shop-button btn">
										Shop Now
									</a>
                  ...
                  <div class="right-side col-lg-8 pl-lg-5">
                      ...
                      <div class="sub-columns">
                          ...
                          <div class="sub-two-right">
                              <h6>Our Store</h6>
                              <p class="mb-5">DivyaNagar,Ghatkesar,Telangana</p>
                          </div>
                      </div>
                  </div>
              </div>
